...
import { Navigate, useLocation } from "react-router-dom"; // 🔹 ajout useLocation
...
export default function Auth() {
  ...
  // 🔹 On récupère le redirect ou "/" par défaut
  ...
  if (user) {
    return <Navigate to={redirectPath} replace />; // 🔹 utilise redirect dynamique
  }
